$(document).ready(function() {
  ...
  function createNewRow(post) {
    ...
    // Create New Upvote and Downvote Elements
    const newUpvote = $("<i>");
    newUpvote.addClass("fas fa-thumbs-up");
    const newDownvote = $("<i>");
    newDownvote.addClass("fas fa-thumbs-down");
    ...
    // Append Upvote and Downvote
    newPostCardHeading.append(newUpvote);
    newPostCardHeading.append(newDownvote);
